...
public class LatLonGeoHashFunctionFactory implements FunctionFactory {

    @Override
    public String getSignature() {
        return "latlon_geohash(DDi)";
    }
    ...
    public Function newInstance(
        ...
        return new LatLonFunction(args.get(0), args.get(1), bits);
    }

    private static class LatLonFunction extends GeoHashFunction implements Function {
        private final Function lat;
        private final Function lon;
        private final int bits;

        public LatLonFunction(Function lat, Function lon, int bits) {
